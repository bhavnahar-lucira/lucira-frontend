          ...
          <div className="bg-zinc-900 rounded-[4px] p-8 text-white relative overflow-hidden shadow-xl shadow-zinc-200">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <a href="https://wa.me/+917208934784" target="_blank" className="flex items-center justify-between p-4 bg-white/5 rounded-sm hover:bg-white/10 transition-colors border border-white/5">
