...
export default function PaymentPage() {
  ...
  return (
    <div className="bg-white min-h-screen overflow-x-clip">
          ...
          <div className="grow lg:basis-[60%] lg:shrink-0 py-10 px-0 lg:pr-12 space-y-10 bg-white">
            ...
            {!isDesktop && (
              <div className="space-y-6 px-4">
                <div className="border-t border-[#EBE1D7]">
                  ...
                  <PriceProtectionTimer 
                    ...
                    className="rounded-t-none rounded-b-[8px] mx-4 mb-2"
                  />
                </div>
                      ...
                      {paymentGateways.map((gateway) => (
                        <div key={gateway.id} className="relative">
                          <Label 
                            ...
                            className={`block p-4 rounded-[6px] border transition-colors cursor-pointer ${selectedPaymentGateway === gateway.id ? "border-[#5A413F] bg-[#FAF0E6]/20" : "border-[#EBE1D7]"}`}
                          >
          ...
          <div className="flex items-center px-0.5">
            <span className="text-[14px] font-medium text-black font-figtree flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 ml-1">
                ...
                <Image src="https://cdn.shopify.com/s/files/1/0739/8516/3482/files/Icon_rupay.svg" className="h-[12px] w-auto" alt="RuPay" width={36} height={12} unoptimized />
      ...
      <PriceProtectionDrawer open={showPriceProtection} onOpenChange={setShowPriceProtection} />
      <CoinsNudgeDrawer 
        open={showCoinsNudge} 
