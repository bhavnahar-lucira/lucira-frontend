...
export const ALL_STORES = [
  {
    ...
    whatsappLink: "https://api.whatsapp.com/send?phone=+917208934782&text=Hi%2C%20I%E2%80%99d%20like%20to%20visit%20the%20Head%20Office%20and%20explore%20the%20designs.",
  ...
  },
  {
    ...
    whatsappLink: "https://api.whatsapp.com/send/?phone=+917208934782&text=Hi%2C+I%E2%80%99d+like+to+visit+the+Borivali+Lucira+store+and+explore+the+designs.&type=phone_number&app_absent=0",
  ...
  },
  {
    ...
    whatsappLink: "https://api.whatsapp.com/send/?phone=+917208934782&text=Hi%2C+I%E2%80%99d+like+to+visit+the+Chembur+Lucira+store+and+explore+the+designs.&type=phone_number&app_absent=0",
  ...
  },
  {
    ...
    whatsappLink: "https://api.whatsapp.com/send/?phone=+917208934782&text=Hi%2C+I%E2%80%99d+like+to+visit+the+Pune+Lucira+store+and+explore+the+designs.&type=phone_number&app_absent=0",
  ...
  },
  {
    ...
    whatsappLink: "https://api.whatsapp.com/send?phone=+917208934782&text=Hi%2C%20I%E2%80%99d%20like%20to%20visit%20the%20Noida%20Store%20and%20explore%20the%20designs.",
  ...
  },
  {
    ...
    whatsappLink: "https://api.whatsapp.com/send/?phone=+917208934782&text=Hi%2C+I%E2%80%99d+like+to+visit+the+Paschim+Vihar+Lucira+store+and+explore+the+designs.&type=phone_number&app_absent=0",
  ...
  },
  {
    ...
    whatsappLink: "https://api.whatsapp.com/send/?phone=+917208934782&text=Hi%2C+I%E2%80%99d+like+to+visit+the+Lajpat+Nagar+Lucira+store+and+explore+the+designs.&type=phone_number&app_absent=0",
                ...
                <div key={i} className="group flex flex-col bg-white border border-[#e6e1de] rounded-sm overflow-hidden transition-all hover:border-black/10">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      {!store.openingSoon && store.rating && (
                    ...
                    <div className="mt-auto space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        {store.openingSoon ? (
                          <Button asChild className="w-full h-11 rounded-sm bg-[#5a413f] hover:bg-[#4a3533] text-white font-figtree font-semibold text-sm transition-all shadow-md">
                            <a href={store.whatsappLink} target="_blank" rel="noopener noreferrer">Inquire on WhatsApp</a>
                          </Button>
                        ) : (
                          <>
                            {/* WhatsApp — Icon Only */}
                            <Button asChild variant="outline" className="w-11 h-11 p-0 shrink-0 rounded-sm border-zinc-200 text-zinc-600 hover:border-[#25D366] hover:text-[#25D366] hover:bg-white transition-all">
                              <a href={store.whatsappLink} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
                            ...
                            <Button asChild variant="outline" className="flex-1 h-11 rounded-sm border-zinc-200 text-zinc-600 hover:border-[#8C5A4C] hover:text-[#8C5A4C] hover:bg-white font-figtree font-semibold text-sm transition-all">
                            ...
                            {/* See Designs */}
                            <Button asChild className="flex-1 h-11 rounded-sm bg-[#5a413f] hover:bg-[#4a3533] text-white font-figtree font-semibold text-sm transition-all shadow-md">
