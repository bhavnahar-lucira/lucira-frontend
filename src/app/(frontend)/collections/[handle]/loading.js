  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="hidden md:block bg-[#FFF5F1] overflow-hidden">
        <div className="container-main flex flex-col md:flex-row items-center">
          ...
          <div className="flex-1 relative w-full h-[230px]">
            <Image 
              src="https://cdn.shopify.com/s/files/1/0739/8516/3482/files/PLP_Banner_jpg.jpg" 
              alt="Loading" 
              fill 
      ...
      <div className="md:hidden w-full relative h-40">
        <Image src="https://cdn.shopify.com/s/files/1/0739/8516/3482/files/PLP_Banner_jpg.jpg" alt="Loading" fill className="object-cover" priority unoptimized />
