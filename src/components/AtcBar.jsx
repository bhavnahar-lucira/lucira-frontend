                      ...
                      return (
                        <div key={store.id || store.shopifyId} className="border border-gray-100 rounded-xl p-4 bg-gray-50/50 flex flex-col gap-2.5">
                          ...
                          <div className="flex items-center gap-2 pt-0.5">
                            <a
                              href={`https://wa.me/+917208934784?text=${encodeURIComponent(`Hi, I would like to check the availability of ${product?.title || "a design"} at the ${displayName} store.`)}`}
                              target="_blank"
                            ...
                            <a
                              href={`tel:${store.phone || "+917208934784"}`}
...
export default function AtcBar({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "atcBar fixed top-0 left-0 w-full bg-white z-[100] border-b border-gray-100 transition-all duration-500 transform shadow-sm px-4 lg:px-17 py-3",
              ...
              <>
                ...
                <div className="hidden xl:flex items-center gap-2">
                  <Button asChild className="h-14 w-14 border border-accent text-accent rounded-sm flex items-center justify-center bg-white hover:bg-[#FFF5F5] transition-colors">
                    <a href="https://wa.me/+917208934784?text=Hi,%20I%20want%20to%20book%20home%20trial%20" target="_blank">
                      <Home size={20} />
                    </a>
                  </Button>
                </div>
      ...
      >
        <div className="max-w-480 mx-auto px-4 lg:px-17">
          ...
          <div className="lg:hidden pointer-events-auto bg-white border-t border-gray-100 shadow-[0_-4px_10px_rgba(0,0,0,0.05)] -mx-4 px-4 py-3 flex items-center gap-2 w-screen">
            {/* WhatsApp */}
            <a
              href={`https://api.whatsapp.com/send/?phone=+917208934784&text=Hi%2C+I+want+to+get+more+information+about+this+product%3A+${encodeURIComponent(product?.title || '')}&type=phone_number&app_absent=0`}
              target="_blank"
              rel="noopener noreferrer"
