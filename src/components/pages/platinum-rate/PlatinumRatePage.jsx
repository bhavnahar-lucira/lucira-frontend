                                        ...
                                        <div className="flex-1 flex flex-col h-full overflow-hidden justify-center">
                                            ...
                                            <div className="flex items-end justify-between mt-auto">
                                                ...
                                                {platinumWidgetSettings.flip_card_link_label && (
                                                    <Link prefetch={false} href={platinumWidgetSettings.flip_card_link_url || "#"} className="text-[9px] md:text-[10px] font-bold text-primary uppercase tracking-widest hover:text-black transition-colors flex items-center gap-1">
