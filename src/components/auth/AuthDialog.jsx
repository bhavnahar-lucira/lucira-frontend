  ...
  if (isMobile) {
    return (
      <Sheet
        ...
        style={{ zIndex: 2000 }}
      >
        <Sheet.Container className="!bg-white !rounded-t-lg !shadow-[0_-2px_16px_rgba(0,0,0,0.3)] !h-auto !max-h-[90vh] !z-[2000]">
          <Sheet.Content className="!p-0">
            ...
            <Sheet.Scroller className="custom-scrollbar-hide overflow-y-auto">
              <OtpSpinAuth
