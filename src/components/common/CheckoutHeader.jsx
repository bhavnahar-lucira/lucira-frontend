      ...
      <header className="hidden lg:block border-b bg-white sticky top-0 z-50">
        <div className="container-main h-20 flex items-center justify-between">
          ...
          <div className="flex-1 flex items-center justify-end gap-4">
            <div className="flex items-center gap-2 rounded-full bg-[#fcf3ed] px-3.5 py-[7px]">
              <Lock size={12} strokeWidth={2.25} className="text-[#5a413f]" />
              <span className="text-xs font-bold uppercase tracking-[1px] text-[#5a413f] whitespace-nowrap">
                100% Secure
              </span>
            </div>
          </div>
