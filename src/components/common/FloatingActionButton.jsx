...
export default function FloatingActionButton() {
  ...
  const getWhatsAppUrl = () => {
    ...
    if (ctx.type === "index") {
      ...
      return `https://wa.me/+917208934784?text=${encodeURIComponent("Hi, I want to know more about Lucira's scheme.")}`;
    } else if (ctx.type === "old-gold-exchange") {
      // Old Gold Exchange enquiries share the same dedicated line.
      return `https://wa.me/+917208934784?text=${encodeURIComponent("Hi, I want to get more information about Lucira's Old Gold Exchange")}`;
    } else if (ctx.type === "store-locator") {
      // Store-locator enquiries also go to the dedicated line (default message).
      return `https://wa.me/+917208934784?text=${encodeURIComponent(message)}`;
    }
