          ...
          <div className="w-full px-5 lg:px-0">
            ...
            <div className="flex gap-2 mb-6">
              <Button asChild variant="outline" className={`h-12 md:h-14 flex items-center justify-center bg-white border border-[#5A413F] text-[#5A413F] hover:bg-[#5A413F]/5 hover:text-[#5A413F] hover:border-[#5A413F] hover:cursor-pointer transition-all group px-0 shrink-0 ${schemeData ? 'w-12 md:w-14 rounded' : 'flex-1 gap-2 rounded'}`}>
                <a href={`https://api.whatsapp.com/send/?phone=+917208934784&text=Hi%2C+I+want+to+get+more+information+about+this+product%3A+${encodeURIComponent(product?.title || '')}&type=phone_number&app_absent=0`} target="_blank" rel="noopener noreferrer">
                        ...
                        <div className="flex flex-col min-[430px]:grid min-[430px]:grid-cols-2 gap-2">
                          ...
                          <Button
                            onClick={() => {
                              ...
                              window.open("https://api.whatsapp.com/send/?phone=+917208934784&text=Hi%2C+I+want+to+schedule+video+call+&type=phone_number&app_absent=0", "_blank");
                            }}
            ...
            {isCentralInStock && (
              <div className="space-y-4 mt-4">
                ...
                <ExploreCard
                  ...
                  url="https://wa.me/+917208934784?text=Hi,%20I%20want%20to%20book%20an%20appointment"
                ...
                <ExploreCard
                  ...
                  url="https://wa.me/+917208934784?text=Hi,%20I%20want%20to%20try%20this%20at%20home"
                  onClick={() => pushToDataLayer({
                    event: 'promoClick',
                    promoClick: {
                    ...
                    availableStores.map((store) => (
                      <div key={store.id || store.shopifyId} className="border border-gray-100 rounded-xl p-5 space-y-4 bg-gray-50/50">
                        ...
                        <div className="flex flex-1 gap-3 pt-2">
                          <a
                            href={`https://wa.me/+917208934784?text=${encodeURIComponent(
                          ...
                          <Button variant="outline" className="flex-1 font-bold h-11 rounded-sm border-gray-200" asChild>
                            <a href={`tel:${store.phone || "+917208934784"}`}>CALL STORE</a>
                          </Button>
