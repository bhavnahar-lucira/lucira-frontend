            ...
            <div ref={mainAtcRef} className="mb-3">
              <div className="flex gap-2">
                <Button
                  ...
                  className="flex-1 h-12 md:h-14 text-base sm:text-base lg:text-xl font-semibold rounded hover:cursor-pointer tracking-wider relative overflow-hidden gold-shimmer"
                >
                  {addingToCart ? (
                    <>
