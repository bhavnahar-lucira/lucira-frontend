...
// jump when the real cards land: image, then price, title, offer pill and the
// Try At Home / video-call row. No swatch or rating rows — the card dropped the
// swatches, and the rating now sits on the image.
  ...
  return (
    <div className="space-y-4 animate-pulse" aria-hidden="true">
      ...
      <div className="flex flex-col gap-1.5 px-1">
        {/* Price, compare-at price, discount pill (desktop only, as on the card) */}
        <div className="flex items-center gap-2 h-6 lg:h-8">
          <div className="h-5 lg:h-6 w-20 lg:w-24 bg-gray-200 rounded" />
          <div className="h-4 lg:h-5 w-14 lg:w-16 bg-gray-100 rounded" />
          <div className="hidden lg:block h-6 w-16 bg-gray-100 rounded-full" />
        </div>
        ...
        {/* Offer pill */}
        <div className="h-6 lg:h-7 w-32 lg:w-44 bg-gray-100 rounded-full mt-1" />
