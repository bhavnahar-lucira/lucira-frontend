...
export default function PriceProtectionTimer({ secondsLeft = 0, onInfoClick, className = "" }) {
  ...
  return (
    <div 
      className={`flex items-center justify-between gap-2 bg-[#FBEFDD] px-4 py-[12px] cursor-pointer ${className}`}
      onClick={onInfoClick}
    >
      <span className="font-figtree text-[0.875rem] lg:text-[1rem] leading-none font-normal tracking-normal text-[#3D2B28]">
